...
special_rows.target_num_half_way_input = [
  {
    "original": { "var": "x.target_number", "value": "2", "trigger": "parents.target_number" },
    "var": "x.target_number", "value": "2", "trigger": "parents.target_number", times_used: 1,
  },
  {
    "original": { "var": "x.target_number", "value": "3", "trigger": "users.target_number" },
    "var": "x.target_number", "value": "3", "trigger": "users.target_number", times_used: 1,
  },
];
// Same as input plus `.there_is_another` rows
...
special_rows.target_num_last_input = [
  {
    "original": { "var": "x.target_number", "value": "2", "trigger": "parents.target_number" },
    "var": "x.target_number", "value": "2", "trigger": "parents.target_number", times_used: 2,
  },
  {
    "original": { "var": "x.target_number", "value": "3", "trigger": "users.target_number" },
    "var": "x.target_number", "value": "3", "trigger": "users.target_number", times_used: 2,
  },
];
// Same as input plus `.there_is_another` rows
