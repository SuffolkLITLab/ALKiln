...
// 1st generator file
`Feature: I use 2 generator files, file 1

# The 1st of 2 related generator files. This 1st one tests uniqueness within one Scenario.
...
// 2nd generator file
`Feature: I use 2 generator files, file 2

# The 2nd of 2 related generator files. Because ALKiln will try to only generate unique tests between all the generators, this 2nd one tests uniqueness of tests between generators. Only the body of the Scenario should matter for uniqueness.
...
`@alkiln @generated @randomized @constraints
Feature: I use 2 generator files, file 1 (generated by ALKiln)
...
Scenario: ALKiln begs the author's forgiveness. The next tests might be flawed.
  Then ALKiln warns the author about a generator ${ fixts.FLUB_PLACEHOLDER }:
    ...
    [^1]: "Unique tests" are only unique from the other tests ALKiln is generating *right now*. ALKiln doesn't check your regular tests.
    ―――――
    """
...
@alkiln @generated @randomized @constraints
Feature: I use 2 generator files, file 2 (generated by ALKiln)
