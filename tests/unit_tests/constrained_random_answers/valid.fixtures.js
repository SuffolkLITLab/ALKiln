...
// @generator1_scenario1_of_1 @alkiln_warning
...
Scenario: I'm warned with too many numbers in random answers tests
  ...
  Given I start the interview at "test_kickout"
  And get to "end" when I pick from:
    | var | possible_values |
    | user_choice | correct;; wrong |
`;
...
// @generator1_scenario1_of_2 @alkiln_warning
...
// @generator1_scenario2_of_2 @alkiln_warning
