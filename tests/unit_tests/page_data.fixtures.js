...
page_data.show_if = {
  ...
  "fields": [
    ...
    },
    {
      ...
      "tag": "input",
      "guesses": [
        { "var": "showif_text_input", "value": "", "checked": "" }
      ],
      "type": "text"
    },
    {
      ...
      "tag": "textarea",
      "guesses": [
        { "var": "showif_textarea", "value": "", "checked": "" }
      ],
      "type": ""
    },
    {
  ...
  "fields": [
    {
      ...
      "tag": "input",
      "guesses": [
        { "var": "x[i].name.first", "value": "", "checked": "" }
      ],
      "type": "text"
    },
    {
  ...
  "fields": [
    {
      ...
      "tag": "input",
      "guesses": [
        { "var": "your_past_benefits[i].start_date", "value": "", "checked": "" }
      ],
      "type": "date"
    },
    {
    ...
    },
    {
      ...
      "tag": "input",
      "guesses": [
        { "var": "your_past_benefits[i].end_date", "value": "", "checked": "" }
      ],
      "type": "date"
    },
    {
