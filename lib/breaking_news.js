...
function break_the_news({
  ...
  let articles_data = [
    ...
    },
    {
      ...
      body: [`Install ALKilnInThePlayground <span class="version">1.3.1</span> or above on your server to get updates about ALKiln and ALKilnInThePlayground. Then you can get notifications here about any mismatches between your ALKiln version and your ALKilnInThePlayground version, new features, bug fixes, and more. If you're seeing this announcement then something has gone wrong. This shouldn't be possible. Find your closest developer and report this to them at once.`],
