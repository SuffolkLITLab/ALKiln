...
module.exports = {
  ...
  getPageData:  async function ( scope, { html }) {
    ...
    */
    ...
    let all_nodes = $( `#dasigpage, fieldset button, .daquestionactionbutton, .form-group input, .form-group select, .form-group textarea` );
    ...
    for ( let node of all_nodes ) {
      ...
      for ( let name of var_names ) {
        ...
        if ( maybe_map ) { proxies_to_names_map = maybe_map; }
