  ...
  getFieldSelector: async function ( scope, { $, node }) {
    ...
    */
    ...
    if ( matching_nodes.length > 1 && selector !== '#daquestion button' ) {
      let message = `${ matching_nodes.length } items on this page matched the base64 encoded name '${ node.name }'. You may be setting the same variable in multiple places on this page.`;
