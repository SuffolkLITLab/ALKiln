...
module.exports = {
  ...
  getMatchingRows: async function ( scope, { field, var_data }) {
    ...
    */
    ...
    if ( session_vars.get_debug() ) { console.log( `matches:\n`, JSON.stringify( matches )); }
    return matches;
  ...
  steps: {
    ...
    set_regular_var: async ( scope, var_name, set_to ) => {
      ...
      */
      ...
      // Don't continue if the variable doesn't navigate and if this variable
      // cannot be seton this page, trigger an error
