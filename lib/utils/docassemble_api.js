...
da.is_valid_api_key = function ( timeout=3000 ) {
...
da.get_dev_id = async function ( timeout=3000 ) {
...
da.create_project = async function ( project_name, timeout=3000 ) {
...
da.has_server_restarted = async function ( task_id, timeout=3000 ) {
...
da.delete_project = async function ( timeout=3000 ) {
