...
env_vars.getBaseInterviewURL = function () {
  ...
  * Depends on the project name, which may have been changed. */
  ...
  return `${ session_vars.get_da_server_url() }${ new_session }${ env_vars.PLAYGROUND_ID }${ session_vars.get_project_name() }%3A`;
};
...
env_vars.EXTRA_LANGUAGES = session_vars.get_languages();
