 ...
 */
 env_vars.validateEnvironment = function() {
  ...
  // is the name used in GitHub Actions.
  ...
  {
    errorMessage += 'The SERVER_URL GitHub secret must be defined.  the SERVER_URL is the URL of the Docassemble Server where the tests should be run.';
  }
  if (!process.env.REPO_URL)
  {
    errorMessage += "The REPO_URL GitHub secret must be defined.  The REPO_URL is the URL to the Git repo whose Actions are being run.";
  }
