    ...
    // console.log(10)
      ...
      while ( !is_unique && num_attempts < max_attempts ) {
        ...
        for ( let step of scenario.steps ) {
          ...
          // in a similar way
          let story_table_str = get_random_Story_Table({ ids, step });
...
// console.log(100)
  try {
    ...
    // console.log(106)
    log.error({ code: `ALK0000`, context: `generating files internal`, error: tween_error },
...
function get_random_Story_Table({ ids, step }) {
