...
Scenario: Some other scenario ALKiln random test generator2_scenario1_of_1
  ...
  if ( generator_paths.length > 0 ) {
    // Discuss: throw here or send up
    log.throw({ code: `ALK0227`, context: `generate`,
      error: new Error(`ALKiln ran into an error when parsing your constrained random answers generator files. See above.`)
    });
  }
