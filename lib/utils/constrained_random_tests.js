...
Scenario: Some other scenario ALKiln random test generator2_scenario1_of_1
  ...
  if ( generator_paths.length > 0 ) {
    ...
    log.throw({ code: `ALK0227`, context: `generating files`,
      error: new Error(`ALKiln ran into an error when parsing your constrained random answers generator files. See warnings and errors above.`)
    });
  }
