...
function get_tweens({
  ...
  try {
    ...
    error.push( tween_error );
    log.error({ code: `ALK0000`, context: `generating files`, error: tween_error });
  }
