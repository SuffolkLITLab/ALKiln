...
session_vars.get_debug = function () { return process.env.DEBUG || null; };  // TODO: How to isolate debug elsewhere so this file can use the logger?
...
const file_storing_artifact_path = `_al_test_artifacts_dir_name.json`;
session_vars.save_artifacts_path_name = function ( path_name ) {
  /* Save a file with the name of the current artifacts folder.  */
