...
function get_new_file_contents({ doc_AST={}, file_contents=`` }) {
  /**
...
function get_Feature_text({ feature, file_lines }) {
  ...
  add_Feature_randomization_indicator({ file_lines, feature });
...
function add_Feature_randomization_indicator({ file_lines=``, feature={} }) {
   ...
   * @param {array} obj.file_lines - Text of the generator file as a list
   *
   * @returns {undefined}
   * */
