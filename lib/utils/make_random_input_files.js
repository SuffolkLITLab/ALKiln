...
function get_new_file_contents({ scenario_objs, file_contents }) {
  ...
  for ( let scenario_obj_i = 0; scenario_obj_i < scenario_objs.length; scenario_obj_i++ ) {
    ...
    * TODO: Add to description text (.name) */
    ...
    let scenario_top = get_Scenario_top({
      scenario,
...
function get_Scenario_top({ scenario, first_constraints_Step, file_contents_list }) {
  ...
  let step_start_index = as_index( first_constraints_Step.location.line );
