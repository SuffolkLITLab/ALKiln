 ...
 * - [ ] Insert periods between inline logs?
 * */
//

class Log {
  /** Handles logging to the console, saving to debug files,
   *  throwing errors, and logging without new lines.
   *  TODO: integrate reports
   *
   * What are the different log files:
   * - debug_log is very ugly and has notes for developers.
   * - unexpected_results log gets made if there are warnings or
   *   errors to add to it. It too is very ugly.
   * - TODO:
   ...
   *  throwing the error. For example, directly to `log.debug()`.
   *  This is for debugging in case we want to track down specific info
   *  about the environment and context afterwards.
