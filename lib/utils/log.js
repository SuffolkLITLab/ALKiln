...
class Log {
  ...
  debug( debug_opts = {}, ...logs ) {
    ...
    try {
      ...
      let unexpected = `warn error`.includes( level ) || error instanceof Error;
  ...
  // TODO: add cucumber output to report regardless of success or failure...
