 ...
 *    - [ ] Make a file of combined unexpected report and debug logs (needed?)
 *
 * Future issues:
...
class Log {
   ...
   *    - Considering: export the report errors file by itself.
   *
   ...
   *  old bugs.
   *  1. Log (to the console) info during processes that wrap test runs - setup
