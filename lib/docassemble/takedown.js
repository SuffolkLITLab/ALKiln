...
const takedown = async () => {
   ...
   *  DOCASSEMBLE_DEVELOPER_API_KEY secret, delete the Project created for this
   *  test. For local development, clean up Project name in the runtime_config
   *  file.
   * */
...
// 2. Prepare logs
// Local devs: This will be separate from your test artifacts paths unless you
//    pass a `path` argument into the `cucumber` run command
