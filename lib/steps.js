...
Given(/I start the interview at "([^"]+)"[ on ]?(.*)/, async (file_name, optional_device) => {  // √
  ...
  if (!scope.page) {
    ...
    // ---- EVENT LISTENERS ----
    // From https://stackoverflow.com/a/51423688
...
// When I tap the download button "Motions" to get the "Eviction.zip" file
// When I tap the button "Motions" to download the file "Eviction.zip"
// When I tap the "Motions" button to download "Eviction.zip"
// When I tap the button "Motions" to download "Eviction.zip"
// When I tap "Motions" to download "Eviction.zip"
// When I tap "Motions" to download the "Evictions.zip" file
