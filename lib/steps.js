...
After(async function(scenario) {
  ...
  if ( scope.expected_status ) {
    console.log(`1 before: scope.expected_status:`, scope.expected_status, `; changeable_test_status:`, changeable_test_status);
    ...
    console.log(`1 after: scope.expected_status:`, scope.expected_status, `; changeable_test_status:`, changeable_test_status);
  }

  if ( scope.expected_in_report && scope.expected_in_report.length > 0) {
    console.log(`2 before: scenario.result.status:`, scenario.result.status, `; changeable_test_status:`, changeable_test_status);
    ...
    if ( report_includes_all_expected_strings ) { changeable_test_status = `PASSED`; }
    else { changeable_test_status = `FAILED`; }

    // if ( !report_includes_all_expected_strings ) { changeable_test_status = `FAILED`; }
    console.log(`2 after: scenario.result.status:`, scenario.result.status, `; changeable_test_status:`, changeable_test_status);
  }
