...
BeforeStep(async function ( step ) {
  ...
  //    may be challenging.
  reports.addToReport(scope, { type: `row info`, value: step.pickleStep.text });
  reports.indent();
});
    ...
    let custom_timeout = new Promise(function( resolve, reject ) {
      ...
      (async function() {
        try {
          ...
          let err_msg = `ALKiln ran into an error it tried to answer fields on the page with the question id "${ id }". The text above might have more information.`
