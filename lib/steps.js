...
When(/I tap the ?(?:choice|checkbox|radio(?: button)?)? var(?:iable)? "([^"]+)"(?: with the value "([^"]+)")?/, async (var_name, value) => {
  ...
  * 
  * WARNING: Working on how to identify 'None of the above' checkboxes (not checked radios yet).
  *   They have input `name`s like '_ignore0' and `id`s and `for`s like 'labelauty-881450'.
  * 
