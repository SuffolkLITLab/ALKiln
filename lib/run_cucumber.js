...
function build_config( command_args ) {
  ...
  for ( let source of sources_paths ) {
    // https://github.com/cucumber/cucumber-js/blob/main/docs/configuration.md#finding-your-features
    let glob = fg.sync(`${ source }/*.feature`, { ignore: [`${ source }/alkiln_random_*.feature`] });
