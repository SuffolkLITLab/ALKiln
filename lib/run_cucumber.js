...
(async function main() {
  ...
  if ( session_vars.get_origin() === `interview` ) {
    provided_config.paths.append(`/usr/share/docassemble/files/playgroundsources/${session_vars.get_user_id()}/${session_vars.get_user_project_name()}/*.feature`);
  }
  ...
  console.log(5, provided_config.tags);
  var path = require('path');
  console.log(6, provided_config.tags);
  var codeDir = path.dirname(require.main.filename);
  console.log(7, provided_config.tags);
