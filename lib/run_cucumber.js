...
function generate_random_input_file_str( source_file ) {
   ...
   * */
  // let num_tests = source_file.match(/num: (.*)$/)[0];
  // let url = source_file.match(/url: (.*)$/)[0];
  // let ids = source_file.match(/ids: (.*)$/)[0];
  // let opts = source_file.match(/options:\n(.*)/)[0];

  // console.log(num_tests, url, ids, opts)
