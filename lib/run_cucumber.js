...
const generator = require(`./utils/make_random_input_files`)
...
function build_config( command_args ) {
  ...
  for ( let source of sources_paths ) {
    ...
    const new_tests_folder = `_alkiln_generated`;
    generator.make_random_input_files({
      generators_prefix,
      sources_path: source,
      new_tests_folder
    });
...
(async function main() {
  ...
  *   manipluate the output. */
  // TODO: Remove after merging Log class PR
