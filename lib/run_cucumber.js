  ...
  *   manipluate the output. */
  ...
  fs.readFile(summary_file_name, 'utf8', (read_error, text) => {
    ...
    try {
      ...
      /** Note: Don't add to the report files. Those are files
       *  where authors can focus on the info we give them, which
       *  they often miss in the GitHub action. This info should
       *  be in the debug logs if needed. */
